...
const css = ".p0_Dha_section{width:100%;max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:14px;display:flex}.p0_Dha_header,.p0_Dha_headerActions,.p0_Dha_statusLine,.p0_Dha_providerName{align-items:center;display:flex}.p0_Dha_header{justify-content:space-between;gap:12px}.p0_Dha_headerActions{gap:6px}.p0_Dha_header h2,.p0_Dha_muted,.p0_Dha_group h3{margin:0}.p0_Dha_header h2{font-size:16px;font-weight:500;line-height:24px}.p0_Dha_iconButton,.p0_Dha_resetButton,.p0_Dha_loadFailure button{box-sizing:border-box;color:var(--dsw-alias-label-primary);font:inherit;cursor:pointer;background:0 0;border:0}.p0_Dha_iconButton{width:32px;height:32px;color:var(--dsw-alias-label-tertiary);border-radius:6px;justify-content:center;align-items:center;display:inline-flex}.p0_Dha_resetButton,.p0_Dha_loadFailure button{border:1px solid var(--dsw-alias-border-l2);border-radius:6px;height:30px;padding:0 10px;font-size:12px}.p0_Dha_iconButton:hover,.p0_Dha_resetButton:hover:not(:disabled),.p0_Dha_loadFailure button:hover{background:var(--dsw-alias-interactive-bg-hover)}.p0_Dha_iconButton:focus-visible,.p0_Dha_resetButton:focus-visible,.p0_Dha_loadFailure button:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.p0_Dha_resetButton:disabled{opacity:.4;cursor:default}.p0_Dha_muted{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:20px}.p0_Dha_loadFailure{color:var(--dsw-alias-state-error-primary);align-items:center;gap:10px;font-size:13px;line-height:20px;display:flex}.p0_Dha_statusLine{border-left:3px solid var(--dsw-alias-state-success-primary);background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 7%, transparent);min-height:34px;color:var(--dsw-alias-label-secondary);gap:8px;padding:5px 10px;font-size:12px;line-height:18px}.p0_Dha_statusLine[data-warning=true]{border-left-color:var(--dsw-alias-state-warn-label);background:color-mix(in srgb, var(--dsw-alias-state-warn-label) 8%, transparent)}.p0_Dha_statusDot{background:var(--dsw-alias-state-success-primary);border-radius:50%;flex:none;width:7px;height:7px}.p0_Dha_statusLine[data-warning=true] .p0_Dha_statusDot{background:var(--dsw-alias-state-warn-label)}.p0_Dha_summary{border-top:1px solid var(--dsw-alias-border-l2);border-bottom:1px solid var(--dsw-alias-border-l2);grid-template-columns:repeat(4,minmax(0,1fr));margin:0;display:grid}.p0_Dha_summary>div{min-width:0;padding:11px 12px}.p0_Dha_summary>div+div{border-left:1px solid var(--dsw-alias-border-l2)}.p0_Dha_summary dt,.p0_Dha_providerList dt{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:17px}.p0_Dha_summary dd{color:var(--dsw-alias-label-primary);font-variant-numeric:tabular-nums;margin:2px 0 0;font-size:20px;font-weight:600;line-height:26px}.p0_Dha_group{flex-direction:column;gap:8px;display:flex}.p0_Dha_group h3{font-size:13px;font-weight:600;line-height:20px}.p0_Dha_activeList,.p0_Dha_providerList{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.p0_Dha_activeList>li,.p0_Dha_providerList>li{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:8px;min-width:0}.p0_Dha_activeList>li{color:var(--dsw-alias-label-secondary);grid-template-columns:minmax(0,1fr) auto auto;align-items:center;gap:12px;padding:10px 12px;font-size:12px;line-height:18px;display:grid}.p0_Dha_route{flex-direction:column;min-width:0;display:flex}.p0_Dha_route strong,.p0_Dha_providerName strong{overflow-wrap:anywhere;font-size:13px;font-weight:600;line-height:19px}.p0_Dha_route code{color:var(--dsw-alias-label-tertiary);font-family:var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:17px;overflow:hidden}.p0_Dha_providerList>li{padding:10px 12px}.p0_Dha_providerName{justify-content:space-between;gap:12px}.p0_Dha_providerName span{background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-tertiary);border-radius:5px;flex:none;padding:1px 6px;font-size:11px;line-height:17px}.p0_Dha_providerName span[data-active=true]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 10%, transparent);color:var(--dsw-alias-state-success-primary)}.p0_Dha_providerList dl{border-top:1px solid var(--dsw-alias-border-l2);grid-template-columns:repeat(6,minmax(0,1fr));gap:8px;margin:10px 0 0;padding-top:9px;display:grid}.p0_Dha_providerList dd{font-variant-numeric:tabular-nums;margin:1px 0 0;font-size:13px;line-height:19px}@media (width<=620px){.p0_Dha_summary{grid-template-columns:repeat(2,minmax(0,1fr))}.p0_Dha_summary>div:nth-child(3){border-left:0;border-top:1px solid var(--dsw-alias-border-l2)}.p0_Dha_summary>div:nth-child(4){border-top:1px solid var(--dsw-alias-border-l2)}.p0_Dha_activeList>li{grid-template-columns:minmax(0,1fr);gap:5px}.p0_Dha_providerList dl{grid-template-columns:repeat(2,minmax(0,1fr))}}";
...
var ConcurrencyMeterSection_module_css_default = {
	"activeList": "p0_Dha_activeList",
	"group": "p0_Dha_group",
	"header": "p0_Dha_header",
	"headerActions": "p0_Dha_headerActions",
	"iconButton": "p0_Dha_iconButton",
	"loadFailure": "p0_Dha_loadFailure",
	"muted": "p0_Dha_muted",
	"providerList": "p0_Dha_providerList",
	"providerName": "p0_Dha_providerName",
	"resetButton": "p0_Dha_resetButton",
	"route": "p0_Dha_route",
	"section": "p0_Dha_section",
	"statusDot": "p0_Dha_statusDot",
	"statusLine": "p0_Dha_statusLine",
	"summary": "p0_Dha_summary"
};
